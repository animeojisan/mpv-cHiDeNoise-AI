...
local user_opts = {
    ...
    hide_timeout = 1700,                    -- time (in ms) before OSC hides if no mouse movement
    ...
    vid_scale = "auto",                      -- scale osc with the video
    ...
    comments_download_path = "~~desktop/mpv/downloads", -- EXPERIMENTAL - the download path for the comment JSON file
...
local language = {
    ['en'] = {
        welcome = 'mpv-cHiDeNoise-AI 3.5',  -- this text appears when mpv starts
        off = 'OFF',
        na = 'Unavailable',
        none = 'None',
        video = 'Video',
        ...
        ontop = 'Always on top',
        ontopdisable = 'Disable always on top',
...
local function osc_init()
    ...
    if user_opts.vid_scale == "auto" then
        scale_with_video = mp.get_property_native("osd-scale-by-window")
    else
        scale_with_video = user_opts.vid_scale == true
    end
