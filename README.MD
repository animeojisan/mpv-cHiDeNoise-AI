mpv-cHiDeNoise-AI
---
onnxを使用したAIアップスケーリング、フレーム補間、Anime4KなどのGLSLシェーダー、vapoursynthフィルターなど多種多様なツールを搭載。リアルタイム処理で高画質な再生を楽しめるmpvベース（[mpv-lazy](https://github.com/hooke007/mpv_PlayKit)）のAI再生プレーヤーです。（windows11）
